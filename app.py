...
def renovaide_chat():
    ...
    plot_div, actual_dpe, objectif_dpe, actual_cost, objectif_cost, reduction_per = fcts.plot_bilan(DATABASE, data)
    return render_template('chat.html', initial_message=initial_message, plot_div=plot_div, 
                        ...
                        actual_cost=int(actual_cost), objectif_cost=int(objectif_cost), reduction_per=int(reduction_per))
